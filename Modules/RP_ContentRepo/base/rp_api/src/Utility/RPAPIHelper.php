...
class RPAPIHelper  {
   ...
   */
  public function entityConfigCheckExists($entityType, array $values) {

    $entity = \Drupal::entityManager()->getStorage($entityType)->create();
    $config_name = $entity->getConfigDependencyName().$values['name'];
