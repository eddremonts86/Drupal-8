 ...
 * @RPAPIModel(
 *   id = "repo_site",
 *   description = @Translation("Site Repo API Model (all of them)"),
 *   entity = "site",
 *   api_method = "getRepoApiSite"
 * )
 */
class SiteRPRepoAPIModel extends RPRepoAPIModelBase {
  ...
  public function mapping() {
    return [
      ...
      'field_site_languages' => [
        ...
        'entity_field_reference' => 'field_language_content_code',
        'required' => true
      ],
      'field_site_channels' => [
        'api_field' => 'channels',
