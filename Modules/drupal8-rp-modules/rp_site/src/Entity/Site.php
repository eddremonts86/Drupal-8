 ...
 *     "version-history" = "/admin/structure/site/{site}/revisions",
 *     "revision" = "/admin/structure/site/{site}/revisions/{site_revision}/view",
 *     "revision_revert" = "/admin/structure/site/{site}/revisions/{site_revision}/revert",
 *     "translation_revert" = "/admin/structure/site/{site}/revisions/{site_revision}/revert/{langcode}",
 *     "revision_delete" = "/admin/structure/site/{site}/revisions/{site_revision}/delete",
