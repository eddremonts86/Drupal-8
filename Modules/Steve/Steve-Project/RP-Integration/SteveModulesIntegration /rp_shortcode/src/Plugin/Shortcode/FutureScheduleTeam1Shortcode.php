...
/**
 * @file
 * Contains \Drupal\rp_shortcode\Plugin\Shortcode\FutureScheduleTeam1Shortcode.
 */
...
class FutureScheduleTeam1Shortcode extends ShortcodeBase {
    ...
    public function tips($long = FALSE) {
        $output = array();
        $output[] = '<p><strong>' . $this->t('[futureschedule_team1][/futureschedule_team1]') . '</strong> ';
