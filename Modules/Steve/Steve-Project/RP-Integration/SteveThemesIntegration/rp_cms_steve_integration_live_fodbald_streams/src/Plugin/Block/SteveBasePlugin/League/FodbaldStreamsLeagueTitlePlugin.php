...
/**
 * Provides a 'fodbaldstreamsleaguetitleplugin' block.
 *
 * @Block(
 *  id = "fodbaldstreamsleaguetitleplugin",
 *  admin_label = @Translation("Fodbald Streams League Title Plugin"),
 * )
 */
class FodbaldStreamsLeagueTitlePlugin extends BlockBase {
  ...
  public function build() {
    ...
    $data =  [
      '#theme' => 'fodbaldstreamsleaguetitleplugin',
