...
/**
 * Provides a 'fodbaldstreamsteamheadplugin' block.
 *
 * @Block(
 *  id = "fodbaldstreamsteamheadplugin",
 *  admin_label = @Translation("Fodbald Streams Team Head Plugin"),
 * )
 */
class FodbaldStreamsTeamHeadPlugin extends BlockBase {
  ...
  public function build() {
    ...
    $data = [
      '#theme' => 'fodbaldstreamsteamheadplugin',
